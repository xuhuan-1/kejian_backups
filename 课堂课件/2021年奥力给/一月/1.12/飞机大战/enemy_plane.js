...
//         this.enemy.src = this.fly1;
//         // Math.random():返回的是0-1之间的随机数，不包括 0和1
//         // this.x:在最大范围内随机出现飞机
//         // y:保证飞机从顶端飞入
...
//                 // 1、判断子弹x轴坐标在飞机宽度内 
//                 // 2、判断子弹的y轴在飞机的高度内  碰撞
//                 if(bull.offsetLeft+bull.offsetWidth > enemy.offsetLeft 
//                     && bull.offsetLeft < enemy.offsetLeft + enemy.offsetWidth){
//                         if(bull.offsetTop+bull.offsetHeight > enemy.offsetTop 
//                             && bull.offsetTop < enemy.offsetTop + enemy.offsetHeight){
//                             // 子弹已经在飞机区域内了 
//                             // 自出子弹的定时器
//                             clearInterval(bull.timer);
//                             // 移除子弹
//                             bull.parentNode.removeChild(bull);
//                             // 判断为真 时，则替换图片 又一次确定子弹和飞机发生了碰撞
//                             if(enemy.flag){
//                                 enemy.flag = false;
